...
cc.Class({
    ...
    prepare: function (filename) {
        ...
        cc.vv.audioMgr.pauseBMG();
        this.clearCache(filename);
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoiceRecorder", "prepare", "(Ljava/lang/String;)V", filename);
    ...
    release: function () {
        ...
        cc.vv.audioMgr.resumeBMG();
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoiceRecorder", "release", "()V");
        } else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    cancel: function () {
        ...
        cc.vv.audioMgr.resumeBMG();
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoiceRecorder", "cancel", "()V");
        } else if (cc.sys.os == cc.sys.OS_IOS) {
            jsb.reflection.callStaticMethod("VoiceSDK", "cancelRecord");
        }
    },

    writeVoice: function (filename, voiceData, index) {
        if (!cc.sys.isNative) {
            return;
        }
        ...
        //    let d = index;
        //    this.clearCache(filename);
        //    if(jsb.fileUtils.writeDataToFile(fileData,url)){
        //        cc.vv.Global.gameControl.onPlaySound(d);
        //    }
        //}
    ...
    stop: function () {
        ...
        cc.vv.audioMgr.resumeBMG();
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoicePlayer", "stop", "()V");
        } else if (cc.sys.os == cc.sys.OS_IOS) {
    ...
    getVoiceLevel: function (maxLevel) {
        ...
        // if (cc.sys.os == cc.sys.OS_ANDROID) {
        //     return jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoiceRecorder", "getVoiceLevel", "(I)I", maxLevel);
    ...
    setStorageDir: function (dir) {
        ...
        if (cc.sys.os == cc.sys.OS_ANDROID) {
            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/VoiceRecorder", "setStorageDir", "(Ljava/lang/String;)V", dir);
        } else if (cc.sys.os == cc.sys.OS_IOS) {
