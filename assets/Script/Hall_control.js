...
cc.Class({
    ...
    onOpenView: function () {
        ...
        this.loadResTexture(this.background, 'big_bg/hallbg_' + cc.vv.userData.bg_index);
        this.change_bg();
    ...
    change_bg:function(){
        let sprited = this.background.getComponent(cc.Sprite);
        let time = new Date();
        let hour = time.getHours();
        if(6 < hour < 18){
            sprited.spriteFrame = this.bg_arr[1];
        }else{
            sprited.spriteFrame = this.bg_arr[0];
        }
    },
        ...
        switch (type) {
            ...
            case 'zhanji_layer': //战绩
            {
                if (this.zhanji_layer == null) {
                    ...
                    this.zhanji_layer.getComponent('Zhanji_layer').onOpenView();
                }
                break;
            }
