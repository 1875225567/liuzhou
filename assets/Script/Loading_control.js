...
cc.Class({
    ...
    onLoad: function () {
        ...
        this.splashScene.runAction(cc.sequence(
            cc.callFunc(function () {
                this.onToggleView('waiting_layer');
                this.onToggleView('msg_node');
        ...
        cc.vv.Global.camera = this.camera;

        //cc.Test.backLocation();//获取玩家手机型号
    },

    onGameHide: function () {
        cc.audioEngine.pauseAll();
        //if (this.game_status == 3 && cc.gameControl) {
        //cc.gameControl.enabled = false; //中断脚本
        //}
    ...
    onGameShow: function () {
        ...
        //if (this.game_status == 3 && cc.gameControl) {
        //    //cc.gameControl.enabled = true; //激活脚本
        //    cc.gameControl.sendJinru(); //重连游戏

        //超过5s
        //cc.log("前台：", Date.now() - this.currentTime);
        //if(cc.gameControl.vote_layer && cc.gameControl.vote_layer.active){
        //cc.gameControl.vote_layer.getComponent('vote_layer').changeTime(parseInt((Date.now() - this.currentTime) / 1000));
        //}
        //if (this.currentTime != null && Date.now() - this.currentTime > 10000) {
        //    cc.vv.WebSocket.onCloseWebSocket(true);
        //cc.log("是否在游戏中：", this.game_status, cc.gameControl);
        //if (cc.gameControl) {
        //    //cc.gameControl.enabled = true; //激活脚本
        //    cc.gameControl.sendJinru(); //重连游戏
        //    cc.log("重连游戏");
        ...
        //if (this.game_scene && this.game_scene.active) {
        //    //在游戏中***
        //    //let control = this.game_scene.getChildByName('control');
        //    //let js = control.getComponent('Game_control');
        //    //js.cleanJS();
        //    this.node_layer.removeChild("game_scene");
        //    this.game_scene = null;
        //    this.loadSceneByName('game_scene', true);
        //} else {
        //    //this.loadSceneByName('login_scene', false);
        //}
        //this.currentTime = null;
        //}
    },
    ...
    cancelReConnect: function () {
        ...
        if (cc.gameControl && cc.gameControl.enabled) {
            //处于游戏状态
            console.log("发送进入消息");
    ...
    showWaiting: function (bool) {
        if (this.waiting_layer && this.waiting_layer.active) {
